    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (checkconnection && CheckInternetConnection())
            {
                ...
                Download("http://blue-programming.bplaced.net/DragonboatTool/Englisch/", "v.version");
                if (File.Exists("v.version"))
                {
                    StreamReader scanner = new StreamReader("v.version");
                    try
                ...
                if (Version > Version_alt || Version_alt > Version)
                {
                    ...
                    {
                        Download("http://blue-programming.bplaced.net/DragonboatTool/Englisch/", "Update.exe");
                        Process.Start("Update.exe");
                        Application.Exit();
                    }
                }
            ...
            dt.Columns.Add(new DataColumn("Wight", typeof(int)));
            dt.Columns.Add(new DataColumn("Gender"));
            dt.Columns.Add(new DataColumn("Side"));
            dt.Columns.Add(new DataColumn("Steerer"));
            if (sName.Count == 0)
            {
                AddNewRow(dt, "Example-Name", 80, "Male", "Right","X");
            }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tabControl1.SelectedIndex == 2)
            {
                ...
                {
                    lbTeamNameBearbeiten.Text = "Add a team";
                }
                else
                {
        ...
        private void SeitenSortieren()
        {
            ...
            for (int i = 0; i < sSeite.Count; i++)
            {
                if (sSeite[i] == "Right")
                {
                    SortierungsIndexRechts = sSeite.IndexOf("Right", SortierungsIndexRechts);
                    sPaddlerRechts.Add(sName[SortierungsIndexRechts]);
                    SortierungsIndexRechts++;
                }
                else if (sSeite[i] == "Left")
                {
                    SortierungsIndexLinks = sSeite.IndexOf("Left", SortierungsIndexLinks);
                    sPaddlerLinks.Add(sName[SortierungsIndexLinks]);
                    SortierungsIndexLinks++;
                }
                else
                {
                    SortierungsIndexBeides = sSeite.IndexOf("Both", SortierungsIndexBeides);
        ...
        private void DeSerialisierung()
        {
            ...
            for (int i = 0; i < x.Paddler.sName.Count; i++)
            {
                ...
                {
                    MessageBox.Show("Broken Save File", "Error");
                }
        ...
        private void cmdPaddlerplus_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("The name has already been used!", "Error");
            }
        }
        ...
        private void cmdPaddlerMinus_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter the Name of the Paddler you want to delete", "Error");
            }
            else
            {
                MessageBox.Show("Can't find Name", "Error");
            }
        ...
        private void cmdPaddlerBearbeiten_Click(object sender, EventArgs e)
        {
            if (txtPaddlerBearbeiten.Text != "")
            {
                ...
                if (sSeite[Index] == "Right")
                {
                    rbRechtsBearbeiten.Checked = true;
                }
                else if (sSeite[Index] == "Left")
                {
                    rbLinksBearbeiten.Checked = true;
                }
                else if (sSeite[Index] == "Both")
                {
            ...
            {
                MessageBox.Show("Please enter the name of the Paddler you want to edit!", "Error");
            }
        }
        ...
        private void cmdTeamMinus_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a team you want to delete", "Error");
            }
            else
            {
        ...
        {
            if (lBTeams.SelectedIndex < 0) { MessageBox.Show("Please select a team", "Error"); }
            else
            {
                ...
                {
                    MessageBox.Show("Paddler is already part of this team", "Error");
                }
            }
            AnzahlPaddlerTeamSeite();
        }
        ...
        {
            if (lBPaddlerTeam.SelectedIndex < 0) { MessageBox.Show("Please select a Paddler", "Error"); }
            else
            {
                if (lBTeams.SelectedIndex > -1)
                {
        ...
        private void lBTeams_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (lBTeams.Items.Count == 0)
            {
                lbTeamNameBearbeiten.Text = "Add a Team to list";
            }
            else
            {
                lbTeamNameBearbeiten.Text = "Select a Team from list";
                if (lBTeams.SelectedIndex > -1)
                {
                    lbTeamNameBearbeiten.Text = lBTeams.SelectedItem.ToString();
                    for (int i = 0; i < Teams[lBTeams.SelectedIndex].sPaddler.Count; i++)
        ...
        private void cmdSpeichern_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter a Linup-Name!", "Error");
            }
        }
        ...
        private void AnzahlPaddlerTeamSeite()
        {
            ...
            for (int i = 0; i < lBPaddlerTeam.Items.Count; i++ )
            {
                ...
                if (sSeite[sName.IndexOf(lBPaddlerTeam.Items[i].ToString())] == "Right")
                {
                    TeamRechts++;
                }
                else if (sSeite[sName.IndexOf(lBPaddlerTeam.Items[i].ToString())] == "Left")
                {
                    TeamLinks++;
                }
                else if (sSeite[sName.IndexOf(lBPaddlerTeam.Items[i].ToString())] == "Both")
                {
                    TeamBeides++;
                }
            }
        ...
        private void cBAufstellungZuweisen()
        {
            if (cBBootsTyp.SelectedIndex == 0 && cBTeams.SelectedIndex > -1)
            {
                ...
                {
                    if (!cB10R1.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R2.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R3.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R4.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R5.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R6.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R7.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R8.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R9.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10R10.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L1.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L2.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L3.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L4.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L5.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L6.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L7.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L8.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L9.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB10L10.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
            ...
            else if (cBBootsTyp.SelectedIndex == 1 && cBTeams.SelectedIndex > -1)
            {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5R1.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5R2.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5R3.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5R4.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5R5.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Right" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5L1.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5L2.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5L3.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5L4.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
                ...
                for (int i = 0; i < Teams[cBTeams.SelectedIndex].sPaddler.Count; i++)
                {
                    if (!cB5L5.Items.Contains(Teams[cBTeams.SelectedIndex].sPaddler[i]) && (sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Left" || sSeite[sName.IndexOf(Teams[cBTeams.SelectedIndex].sPaddler[i])] == "Both"))
                    {
        ...
        private void cmdLogoHinzufügen_Click(object sender, EventArgs e)
        {
